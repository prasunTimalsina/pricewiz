...
//        className="px-4 py-2 border w-full light:text-black dark:text-white focus:outline-none rounded-l-2xl ring-2 ring-white"
//      />
//      <Link
//
//        ref={linkRef}
//        href={`/product/query?q=${encodeURIComponent(query.trim())}`}
//        className="px-4 py-2 bg-black  ring-2 ring-white text-white font-semibold rounded-r-2xl hover:bg-white hover:text-black transition"
//      >
//        Go
//      </Link>
//    </div>
