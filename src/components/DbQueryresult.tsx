...
export default function Dbqueryresult() {
  ...
  if (loading)
    return (
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-6 px-4 py-10">
        {Array.from({ length: 10 }).map((_, i) => (
          <div
            key={i}
            className="w-full sm:w-[48%] md:w-[30%] lg:w-[22%] xl:w-[18%] flex justify-center"
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-6 px-4 mb-10">
        {products.map((product) => (
          <div
            key={product.id}
            className="w-full mx-6 sm:w-[48%] md:w-[30%] lg:w-[22%] xl:w-[18%] flex justify-center"
          >
            <DbCard product={product} />
          </div>
        ))}
